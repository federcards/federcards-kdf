...
public CRYPTO_RANDOMPOOL as string*64
...
function crypto_random32bytes() as string
    ...
    for i=33 to 64 step 4
        r = Rnd
        Mid$(CRYPTO_RANDOMPOOL, i, 4) = (r as String*4)
    ...
    next
    Left$(CRYPTO_RANDOMPOOL, 32) = Sha256Hash(CRYPTO_RANDOMPOOL)
    crypto_random32bytes = Left$(CRYPTO_RANDOMPOOL, 32)
end function
